...
const Profile = () => {
  const options = ["Not Selected",
  "Paper Presentation",
  "Circuit Carnival",
  "Code Craft",
  "Quiz Mania",];
  const original = ["Not Selected",
  "Paper Presentation",
  "Circuit Carnival",
  "Code Craft",
  "Quiz Mania",];
        ...
        >
          ...
          {!(verifyRequest() === "Payment Successful") && (
            <div>
              ...
              <div classname={`mt-3`}>
              <p>Kindly fill the below g form <a href="https://forms.gle/dnhud95XaYymA1tH9" target="_blank">https://forms.gle/dnhud95XaYymA1tH9</a></p>
              </div>
              <div className={`mt-3`}>
                ...
                <button
                  ...
                  onClick={() => {
                    if (selectedIndex === 0) {
                      ...
                      setMessage("Select Any one Event");
                      setMessageBack("red");
                    }
